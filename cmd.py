...
# TODO: appoint certain compute card
...
QA_PROMPT = False # True: Q & A prompt // False: User & Bot prompt (needs bigger model)
...
if CHAT_LANG == 'English':
    args.MODEL_NAME = '/root/bjwswang/ai-modesl/rwkv/rwkv-4-world/RWKV-4-World-3B-v1-20230619-ctx4096'
